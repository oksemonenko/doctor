    ...
    items: [
      {
        index: 0,
        image: Bailarin1,
        name: 'Una revolución sin bailar es una revolución que no vale la pena tener',
        description: 'V significa Vendetta; Alan Moore, David Lloyd',
      },
      {
        index: 1,
        image: Bailarin2,
        name: 'La forma en que la gente se mueve es su biografía en movimiento',
        description: 'Jerry Spence',
      },
      {
        index: 2,
        image: Bailarin3,
        name: 'Los grandes bailarines no son geniales por su técnica, son geniales por su pasión',
        description: 'Martha Graham',
      },
      {
        index: 3,
        image: Bailarin4,
        name: 'Las orejas del bailarín están de puntillas',
