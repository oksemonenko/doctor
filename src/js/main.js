...
import Flickity from './flickity.pkgd.min';
import imagesLoaded from './flickity.pkgd.min';
import classie from './flickity.pkgd.min';
...
(function() {
	...
	var bodyEl = document.body,
		...
		stacksWrapper = slider.querySelector('.stacksData-wrapper'),
